...
public class MainRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Postazione postazione03 = Postazione.builder().capienzaMax(f.number().numberBetween(5, 30))
				...
				.libero(true).edificio(edificio01)
				.build();
		...
		Postazione postazione07 = Postazione.builder().capienzaMax(f.number().numberBetween(5, 30))
				...
				.tipoPostazione(TipoPostazione.SALA_RIUNIONI).libero(true).edificio(edificio03)
				.build();
		...
		Prenotazione prenotazione01 = Prenotazione.builder().dataInizio(LocalDate.now()).user(user01)
				.postazione(postazione01).build();
